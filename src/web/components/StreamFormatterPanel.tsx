...
const FORMATTER_TOKENS = [
  ...
  { label: "3D type", token: "{stream.3dtype}" },
...
const PREVIEW_CONTEXT = {
  ...
  stream: {
    ...
    filename: "Avatar.2009.2160p.Full-SBS.DV.HDR10.HEVC.TrueHD.Atmos.7.1.mkv",
    path: "/Movies/Avatar.2009.2160p.Full-SBS.DV.HDR10.HEVC.TrueHD.Atmos.7.1.mkv",
    extension: ".mkv",
    container: "mkv",
    quality: "2160p",
    resolution: "2160p",
