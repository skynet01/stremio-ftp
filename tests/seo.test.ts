...
describe("static SEO metadata", () => {
  it("exposes search and social metadata for the public landing page", () => {
    ...
    expect(html).toContain('property="og:image" content="https://raw.githubusercontent.com/skynet01/stremio-ftp/main/screenshot-1.jpg"');
    expect(html).toContain('property="og:image:alt" content="Stremio FTP Addon configuration portal screenshot"');
    expect(html).toContain('name="twitter:card" content="summary"');
    expect(html).toContain('name="twitter:image" content="https://raw.githubusercontent.com/skynet01/stremio-ftp/main/screenshot-1.jpg"');
